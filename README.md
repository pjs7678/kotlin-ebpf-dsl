...
| `tcplife()` | TCP connection duration histogram | tracepoint (sock) |
| `syscount()` | System call counting | raw_tracepoint |
| `capable()` | Security capability check counting | kprobe |
